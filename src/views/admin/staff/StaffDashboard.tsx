      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 card-container p-8 bg-white/40 backdrop-blur-md">
          <div className="flex justify-between items-center mb-6">
            ...
            <button onClick={() => navigate('/tickets?assignedTo=me')} className="text-[10px] font-black text-primary hover:text-secondary tracking-widest uppercase transition-colors">Xem tất cả</button>
          </div>
