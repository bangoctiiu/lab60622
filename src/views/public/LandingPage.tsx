...
import { 
  ...
  ChevronUp, Star, Layout, Smartphone, PieChart
} from 'lucide-react';
        ...
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center z-10">
          <div className="text-white space-y-8 animate-in fade-in slide-in-from-left duration-700">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <button className="px-8 py-4 bg-accent text-white rounded-md font-bold text-lg hover:scale-105 transition-transform flex items-center gap-2">
