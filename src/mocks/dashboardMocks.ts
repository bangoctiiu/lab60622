import { KPIData, RevenueDataPoint, OccupancyData, RecentPayment, RecentTicket, ElectricityDataPoint, AnalyticsAlert } from '@/models/Dashboard';
...
export const MOCK_OCCUPANCY_STATS: OccupancyData = {
  occupied: 1040,
  vacant: 120,
  maintenance: 45,
  reserved: 35,
...
export const MOCK_RECENT_TICKETS: RecentTicket[] = [
...
export const MOCK_ELECTRICITY_CHART: ElectricityDataPoint[] = [
...
export const MOCK_ANALYTICS_ALERTS: AnalyticsAlert[] = [
